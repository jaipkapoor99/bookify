-- Fix the book_ticket function to use the correct column name
-- The database has 'event_venue_id' but the function was trying to use 'events_venues_id'
...
BEGIN
  ...
  -- Create the ticket with quantity - FIXED: using event_venue_id instead of events_venues_id
