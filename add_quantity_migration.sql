-- Migration: Add quantity column to tickets table
-- This script adds the quantity column and updates the book_ticket function

-- Step 1: Add quantity column to tickets table (if it doesn't exist)
DO $$
BEGIN
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Added quantity column to tickets table';
    ELSE
        RAISE NOTICE 'Quantity column already exists in tickets table';
    END IF;
END
$$;

-- Step 2: Update the book_ticket function to support multiple tickets
