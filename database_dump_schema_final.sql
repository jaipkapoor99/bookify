...
CREATE POLICY "Allow anonymous to view events" ON "public"."events" FOR SELECT USING (true);



CREATE POLICY "Allow anonymous to view events_venues" ON "public"."events_venues" FOR SELECT USING (true);



CREATE POLICY "Allow anonymous to view locations" ON "public"."locations" FOR SELECT USING (true);



CREATE POLICY "Allow anonymous to view venues" ON "public"."venues" FOR SELECT USING (true);
...
CREATE POLICY "Enable read access for all users on events_venues" ON "public"."events_venues" FOR SELECT USING (true);



CREATE POLICY "Users can insert their own profile" ON "public"."users" FOR INSERT TO "authenticated" WITH CHECK (("supabase_id" = "auth"."uid"()));



CREATE POLICY "Users can read their own profile" ON "public"."users" FOR SELECT TO "authenticated" USING (("supabase_id" = "auth"."uid"()));



CREATE POLICY "Users can update their own profile" ON "public"."users" FOR UPDATE TO "authenticated" USING (("supabase_id" = "auth"."uid"())) WITH CHECK (("supabase_id" = "auth"."uid"()));



CREATE POLICY "Users can view their own tickets" ON "public"."tickets" FOR SELECT TO "authenticated" USING (("customer_id" IN ( SELECT "users"."user_id"
   FROM "public"."users"
